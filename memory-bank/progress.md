...
- 20260329: 已完成 v0.6.0 发布方案设计，下一步实现安装器脚本、自包含发布和 GitHub Release 流程。
- 20260329: 已完成 v0.6.0 本地发布链：
  - 新增 `build/release` 发布脚本与 Inno Setup 安装器脚本
  - 兼容脚本支持安装目录
  - 产物已成功生成并通过安装/运行/卸载 smoke
